"""
Generate extended news headlines dataset for advanced NLP tasks
Creates 10,000 headlines across 4 categories for embeddings and language modeling
"""
...
if __name__ == "__main__":
    # Generate dataset
    print("=" * 60)
    print("EXTENDED NEWS HEADLINES GENERATOR")
    print("=" * 60)
    print(f"Start time: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print()

    df = generate_headlines(n_per_category=2500)
    ...
    # Save to CSV
    output_file = '../extended/news_headlines_extended.csv'
